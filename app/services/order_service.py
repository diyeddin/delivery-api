...
class OrderService:
    """Service class for order-related business logic (synchronous)."""
    ...
    def update_order_status(
        ...
        # If cancelling, also clear any driver assignment
    ...
    def _validate_status_transition(
        ...
        if user.role == models.UserRole.admin:
            # Specific admin-friendly error messages expected by tests
            # Cancelling already finalised orders
    ...
    def assign_driver_to_order(self, order_id: int, driver_id: int) -> models.Order:
        ...
        # (tests expect admin assignment immediately after creation)
